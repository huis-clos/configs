...
DEFAULT_USER="colltoth"

# Path to your oh-my-zsh installation.
export ZSH=/Users/colltoth/.oh-my-zsh
...
export NVM_DIR="/Users/colltoth/.nvm"
[ -s "$NVM_DIR/nvm.sh" ] && \. "$NVM_DIR/nvm.sh"  # This loads nvm
[[ -s "$HOME/.avn/bin/avn.sh" ]] && source "$HOME/.avn/bin/avn.sh" # load avn
PATH=/usr/local/Cellar/ruby@2.3/2.3.4/bin:$PATH

if test -f ~/.pusheen; then
        cat ~/.pusheen
fi

alias proxy='ssh -fNT -L 4320:proxy.elementalad.com:3128 colltoth@proxy.elemental.amazon.com'
